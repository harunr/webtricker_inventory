...
Route::group(['middleware' => ['auth', 'active']], function() {
    ...
    Route::post('customer/due_payment','CustomerController@customer_due_payment')->name('customer_due_payment');
    Route::post('customer/customer_due_payment_pos','CustomerController@customer_due_payment_pos')->name('customer_due_payment_pos');
	...
	Route::get('report/adjustment_report','ReportController@adjustment_report')->name('report.adjustment_report');
