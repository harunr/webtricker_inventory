...
class ReportController extends Controller
{
    ...
    public function adjustment_report(Request $request){

        if($request->warehouse)
            $adjustments = DB::table('adjustments')->where('warehouse_id',$request->warehouse)->orderBy('id','desc')->get();
        else
            $adjustments = DB::table('adjustments')->orderBy('id','desc')->get();

        return view('report.adjustment_report',compact('adjustments'));
    }
}
