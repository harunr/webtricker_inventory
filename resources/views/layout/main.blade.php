    ...
    <div id="loader"></div>
      ...
      <nav class="side-navbar">
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            ?>
            @if($index_permission_active)
            <li class="d-none"><a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-document"></i><span>{{trans('file.Quotation')}}</span><span></a>
            <ul id="quotation" class="collapse list-unstyled d-none">
                ...
                ?>
                @if($add_permission_active)
                <li id="quotation-create-menu d-none"><a href="{{route('quotations.create')}}">{{trans('file.Add Quotation')}}</a></li>
                @endif
            </ul>
            </li>
            @endif
            ...
            <ul id="report" class="collapse list-unstyled ">
                ...
                @endif
                <li>
                    <a href="{{route('report.adjustment_report')}}">Adjustment report </a>
                </li>
