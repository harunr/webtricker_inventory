                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="button" data-id="{{$customer->id}}" class="due btn btn-link" data-toggle="modal" data-target="#dueModal" ><i class="dripicons-plus"></i>Due Payment</button>
                                </li>
                                <li>
...
<div id="dueModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <form action="{{route('customer_due_payment')}}" method="post">
        @csrf 
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">Payment Due</h5>
          <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
        </div>
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
...
<script type="text/javascript">
  ...
  $(".due").on("click", function() {
        var id = $(this).data('id').toString();
        $("#dueModal input[name='customer_id']").val(id);
  });
