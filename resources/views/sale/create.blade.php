                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <?php
                                        $customer_group = DB::table('customer_groups')->get();
                                    ...
                                    ?>
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_group" id="customer_group" class="selectpicker form-control" data-live-search="true" title="Select group...">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{trans('file.customer')}} * <span id="opening_due_div"></span></label>
...
$('#customer_group').change(function(){
        ...
        if(Id){
            ...
            customers.filter(function(item,ind){
                ...
                if(item.customer_group_id == Id){
                    $('#customer_id').append(`<option value="${item.id}">${item.name} </option>`);
                }
    ...
    $('#customer_id').change(function(){
        ...
        customers.map((item)=>{
            if(item.id == Id){
                $('#opening_due_div').html(`Due ${item.opening_due} Tk`);
            }
        })
    })
