...
<section class="forms pos-section">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select required id="customer_group_id" name="customer_group_id" class="selectpicker form-control" data-live-search="true" title="Select group...">
                                                @foreach(DB::table('customer_groups')->get() as $group)
                                ...
                                <div class="col-12 totals" style="border-top: 2px solid #e4e6fc; padding-top: 10px;">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <span class="totals-title">Due Payment <button type="button" class="btn btn-link btn-sm due_payment_modal_btn" data-toggle="modal" data-target="#due-payment-modal"><i class="dripicons-document-edit"></i></button></span><span id="customer_due_amount_div">00 Tk</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="payment-options">
                        ...
                        <div class="column-5">
                            <button style="background-color: #213170" type="button" class="btn btn-custom payment-btn" data-toggle="modal" data-target="#add-payment" id="paypal-btn"><i class="fa fa-bkash"></i>Bkash</button>
                        </div>
                        <div class="column-5">
                                ...
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <input type="number" name="mobile_number" class="form-control"  step="any">
                                        </div>  
                                        <div class="col-md-6 mt-1">
                                            <label>Transaction Number : </label>
                                            <input type="text" name="transaction_id" class="form-control"  step="any">
                                        </div>
            ...
            <div id="due-payment-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form action="{{route('customer_due_payment_pos')}}" method="post">
                        @csrf 
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="hidden" name="customer_hidden_id">
                                <input type="number" name="due_payment_amount" class="form-control">
                            </div>
                    ...
                    <div class="modal-body">
                      <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="opening_due" value="0"  class="form-control">
                        </div>
                        <div class="form-group">
...
var customers = @json($lims_customer_list);
$('#customer_group_id').change(function(){

        let Id = $(this).val();
        
        if(Id){
            $('#customer_id').html(null);
            $('#customer_id').val(0);
            $('#customer_id').selectpicker("refresh");
            customers.filter(function(item,ind){
                return item.customer_group_id == Id;
            }).map(function(item,ind){
                if(item.customer_group_id == Id){
                    $('#customer_id').append(`<option value="${item.id}">${item.name} ${item.opening_due} Tk </option>`);
                    $('#customer_due_amount_div').html(`${item.opening_due} Tk`)
                }
    ...
    $('.due_payment_modal_btn').click(function(){
        var c_id = $('#customer_id').val();
        if(c_id == null){
            alert('please select customer');
        }else{
            $('input[name=customer_hidden_id]').val(c_id);

        }
    })

    var get_customer_id = getSavedValue('customer_id')
    customers.map((item)=>{
        if(item.id == get_customer_id){
            $('#customer_due_amount_div').html(`${item.opening_due} Tk `)
        }
    })
